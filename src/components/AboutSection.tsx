      ...
      >
        ...
        <motion.div style={{ y: imageY }} className="relative mb-8">
          <img
            src="/me.jpg"
            alt="Profile"
            className="w-36 h-36 sm:w-44 sm:h-44 md:w-56 md:h-56 rounded-full object-cover border border-white/20 shadow-[0_0_40px_rgba(0,255,255,0.25)]"
          />
        ...
        <p className="mt-6 text-sm sm:text-base md:text-lg leading-relaxed text-gray-300 max-w-3xl">
          ...
          and competitive programmer who thrives on crafting elegant solutions
          and pushing technical boundaries. I specialize in{" "}
          <span className="text-[#00ffff] font-semibold">
            JavaScript, C++, and modern web technologies
          </span>
          .
        </p>

        <p className="mt-4 text-sm sm:text-base md:text-lg leading-relaxed text-gray-300 max-w-3xl">
          When I’m not coding, I’m probably brainstorming cool UI effects or
          solving algorithms on{" "}
          <span className="text-[#00ffff] font-semibold">LeetCode</span> and{" "}
          <span className="text-[#00ffff] font-semibold">Codeforces</span>.
        </p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          {skills.map((skill, i) => (
            <span
              key={i}
              className="px-4 py-1 text-xs sm:text-sm rounded-full border border-cyan-400/40 text-cyan-300 bg-cyan-400/10 backdrop-blur hover:scale-105 transition"
            >
              {skill}
            </span>
          ))}
